...
const AddUserModal = ({ isOpen, onClose, onAddUser, editingUser, onUpdateUser }) => {
  ...
  const validateForm = () => {
    ...
    if (!formData.role) {
      ...
      alert("Cannot select the admin in role section. Admin is managed separately.");
      newErrors.role = 'Admin role cannot be selected';
      return false;
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Error message already shown in Dashboard.addUser
              ...
              <select
                ...
                onChange={(e) => {
                  if (e.target.value === "admin") {
                    alert("Cannot select the admin in role section. Admin is managed separately.");
                    // Reset to empty or previous value
